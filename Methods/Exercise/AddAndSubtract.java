...
public class AddAndSubtract {
    ...
    public static void main(String[] args) {
        int firstInt = setValue(Integer.MIN_VALUE, Integer.MAX_VALUE);
        int secondInt = setValue(Integer.MIN_VALUE, Integer.MAX_VALUE);
        int thirdInt = setValue(Integer.MIN_VALUE, Integer.MAX_VALUE);

        int result = getSubtractOf(getSumOf(firstInt, secondInt), thirdInt);

        out.println(result);
    }

    private static int getSubtractOf(int sum, int thirdInt) {
        return sum - thirdInt;
    }

    private static int getSumOf(int firstInt, int secondInt) {
