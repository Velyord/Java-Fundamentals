...
public class MathOperations {
    ...
    public static void main(String[] args) {
        double firstNum = setValue(Double.MAX_VALUE * -1, Double.MAX_VALUE);
        char operator = setValue().charAt(0);
        double secondNum = setValue(Double.MAX_VALUE * -1, Double.MAX_VALUE);
        double result = calculateResultOf(firstNum, operator, secondNum);
    ...
    private static double calculateResultOf(double firstNum, char operator, double secondNum) {
        double result = 0;
    ...
    private static <T> boolean hasValidChars(T value) {
        ...
        String specialChars = "!#$%&'(),.:;<=>?@[]^_`{|}0123456789 abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"; // може да се променят забранените символи
