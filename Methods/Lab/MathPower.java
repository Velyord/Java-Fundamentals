...
public class MathPower {
    ...
    public static void main(String[] args) {
        double number = setValue(Double.MIN_VALUE * -1, Double.MAX_VALUE);
        int exponent = setValue(Integer.MIN_VALUE, Integer.MAX_VALUE);
        double result = calculateNumberRaisedToPower(number, exponent);

        out.println(new DecimalFormat("0.####").format(result));
    }

    private static double calculateNumberRaisedToPower(double number, int exponent) {
