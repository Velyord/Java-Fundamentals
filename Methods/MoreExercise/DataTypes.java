...
public class DataTypes {
    ...
    public static void main(String[] args) {
        String type = setValue();
        setValueBy(type);
    }

    private static void setValueBy(String type) {
        switch (type) {
            case "int":    intOutput();    break;
            case "real":   realOutput();   break;
            case "string": stringOutput(); break;
            default: break;
        }
    }
    ...
    private static void realOutput() {
        double input = setValue(Double.MAX_VALUE * -1, Double.MAX_VALUE);
        double output = input * 1.5;

        out.printf("%.2f", output);
    }

    private static void intOutput() {
