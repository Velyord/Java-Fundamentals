/*
Условие:
    Calculate how many courses will be needed to elevate
    n persons by using an elevator with a capacity of
    p persons.
...
Examples:
    ...
    ->
    1
        All the people fit inside the elevator.
...
public class Elevator {
    ...
    public static void main(String[] args) {
        int numberOfPeople = setValue(0, biggestInt);
        int capacity = setValue(0, biggestInt);

        calculateNeededCourses(numberOfPeople, capacity);
    }

    private static void calculateNeededCourses(
            int numberOfPeople,
            int capacity
    ) {
        if (numberOfPeople % capacity == 0)
            out.println(numberOfPeople / capacity);
        else
            out.println(numberOfPeople / capacity + 1);
    }
