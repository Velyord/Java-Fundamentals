...
public class CenturiesToMinutes {
    ...
    public static void main(String[] args) {
        int centuries = setValue(0, biggestInt);

        byte yearsInACentury = 100;
        int years = centuries * yearsInACentury;
        double daysInAYear = 365.2422;
        double days = years * daysInAYear;
        byte hoursInADay = 24;
        double hours = days * hoursInADay;
        byte minutesInAHour = 60;
        double minutes = hours * minutesInAHour;

        out.printf(
                "%d centuries = %d years = %.0f days = %.0f hours = %.0f minutes",
