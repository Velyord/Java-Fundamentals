...
Examples:
    ...
    343424
    101
    -> Town Plovdiv has population of 343424 and area 101 square km.
*/
...
public class TownInfo {
    ...
    public static void main(String[] args) {
        String nameOfTown = setValue(null, null);
        long population = setValue(smallestLong, biggestLong);
        short area = setValue(smallestShort, biggestShort);
        out.printf(
