...
public class WordSynonyms {
    ...
    public static void main(String[] args) {
        int numberOfLines = setValue(0, Integer.MAX_VALUE);
        Map<String, List<String>> synonymsMap = new LinkedHashMap<>();

        for (int i = 1; i <= numberOfLines; i++) {
            addWordAndSynonym(synonymsMap);
        }

        printMap(synonymsMap);
    }

    private static void printMap(Map<String, List<String>> synonymsMap) {
    ...
    private static void addWordAndSynonym(Map<String, List<String>> synonymsMap) {
        String word = setValue();
        String synonym = setValue();
